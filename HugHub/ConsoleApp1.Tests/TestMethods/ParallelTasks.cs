...
namespace ConsoleApp1.Tests.TestMethods
{
    public class ParallelTasks
    {
        ...
        public IEnumerable<string> s_urlList = new string[]
        {
        ...
        public async Task<InsurerQuoteModel> ProcessUrlAsync(string url, HttpClient client)
        {
